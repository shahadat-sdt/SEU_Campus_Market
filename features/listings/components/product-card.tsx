...
import { toggleVote, toggleWishlist } from "@/features/marketplace/actions";
...
export function ProductCard({ listing, canInteract = false }: ProductCardProps) {
        ...
        <div className="flex items-center justify-between gap-2 border-t pt-3 text-xs text-muted-foreground">
          ...
          {canInteract ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1"><ThumbsDown className="h-3.5 w-3.5" /> {dislikes}</span>
              <Link href="/login" aria-label="Login to save listing" className="inline-flex h-8 w-8 items-center justify-center rounded-md hover:bg-accent hover:text-accent-foreground">
